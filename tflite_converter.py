...
def detect_objects(interpreter, frame):
    ...
    with open(r'C:\Users\sumee\Downloads\coco_ssd_mobilenet_v1_1.0_quant_2018_06_29\labelmap.txt', 'r') as f:
...
def capture_video():
    ...
    model_path = r'C:\Users\sumee\Downloads\coco_ssd_mobilenet_v1_1.0_quant_2018_06_29\detect.tflite'
